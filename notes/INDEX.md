...
- [Scaling Rufus with 80,000+ AWS Inferentia and Trainium Chips for Prime Day](genai/cs2241-scaling-rufus-with-80000-aws-inferentia-and-trainium-chips.md) — Amazon · 2024
- [Apple Foundation Models 2025 Updates](genai/cs2245-apple-foundation-models-2025-updates.md) — Apple · 2025
- [Stop Stuffing Prompts: How Asana Made Agents More Effective Through Context Engineering](genai/cs2394-stop-stuffing-prompts-how-asana-made-agents-more-effective.md) — Asana · 2025
- [How Rovo Deep Research Works](genai/cs2228-how-rovo-deep-research-works.md) — Atlassian · 2025
...
- [BewAIre: Malicious Code Detection at Scale](genai/cs2332-bewaire-malicious-code-detection-at-scale.md) — Datadog · 2026
- [How we migrated a live routing system using AI-assisted refactoring](genai/cs2333-how-we-migrated-a-live-routing-system-using-ai.md) — Datadog · 2026
...
- [Building Ask DoorDash Part Three: Evaluation](genai/cs2220-building-ask-doordash-part-three-evaluation.md) — DoorDash · 2025
...
- [Code with Claude: Coding Is No Longer the Constraint](genai/cs2126-code-with-claude-coding-is-no-longer-the-constraint.md) — Spotify · 2026
...
- [Truncation-Free Matching System for Display Advertising at Alibaba](ads/cs1783-truncation-free-matching-system-for-display-advertising-at-alibaba.md) — Alibaba · 2021
- [Exploration in Online Advertising Systems with Deep Uncertainty-Aware Learning](ads/cs1785-exploration-in-online-advertising-systems-with-deep-uncertainty-aware.md) — Alibaba · 2021
- [Bidding-Aware Retrieval for Multi-Stage Consistency in Online Advertising](ads/cs2090-bidding-aware-retrieval-for-multi-stage-consistency-in-online.md) — Alibaba · 2025
- [Amazon Ads Multi-Touch Attribution](ads/cs2171-amazon-ads-multi-touch-attribution.md) — Amazon · 2025
- [GRAB: An LLM-Inspired Sequence-First Click-Through Rate Prediction Modeling Paradigm](ads/cs2174-grab-an-llm-inspired-sequence-first-click-through-rate.md) — Baidu · 2026
- [RankMixer: Scaling Up Ranking Models in Industrial Recommenders](ads/cs1768-rankmixer-scaling-up-ranking-models-in-industrial-recommenders.md) — ByteDance · 2025
- [TokenMixer-Large: Scaling Up Large Ranking Models in Industrial Recommenders](ads/cs1772-tokenmixer-large-scaling-up-large-ranking-models-in-industrial.md) — ByteDance · 2026
- [Improving Consistency Models with Generator-Augmented Flows](ads/cs0833-improving-consistency-models-with-generator-augmented-flows.md) — Criteo · 2025
- [Smart Fast Finish: Preventing Overdelivery via Daily Budget Pacing at DoorDash](ads/cs2317-smart-fast-finish-preventing-overdelivery-via-daily-budget-pacing.md) — DoorDash · 2025
- [Multi-Objective Ranking for Promoted Auction Items](ads/cs1767-multi-objective-ranking-for-promoted-auction-items.md) — eBay · 2022
- [Optimization-Based Budget Pacing in eBay Sponsored Search](ads/cs2089-optimization-based-budget-pacing-in-ebay-sponsored-search.md) — eBay · 2024
- [On the Factory Floor: ML Engineering for Industrial-Scale Ads Recommendation Models](ads/cs2172-on-the-factory-floor-ml-engineering-for-industrial-scale.md) — Google · 2022
...
- [CADET: Context-Conditioned Ads CTR Prediction With a Decoder-Only Transformer](ads/cs1769-cadet-context-conditioned-ads-ctr-prediction-with-a-decoder.md) — LinkedIn · 2026
- [LiDDA: Data Driven Attribution at LinkedIn](ads/cs2175-lidda-data-driven-attribution-at-linkedin.md) — LinkedIn · 2025
- [GRAD: Generative Large-Scale Pre-trained Models for Automated Ad Bidding Optimization](ads/cs1776-grad-generative-large-scale-pre-trained-models-for-automated.md) — Meituan · 2025
- [EGA-V2: An End-to-end Generative Framework for Industrial Advertising](ads/cs2080-ega-v2-an-end-to-end-generative-framework-for.md) — Meituan · 2025
- [Generative Bid Shading in Real-Time Bidding Advertising](ads/cs2081-generative-bid-shading-in-real-time-bidding-advertising.md) — Meituan · 2025
- [NGA: Non-autoregressive Generative Auction with Global Externalities for Advertising Systems](ads/cs2082-nga-non-autoregressive-generative-auction-with-global-externalities-for.md) — Meituan · 2025
- [New AI advancements drive Meta's ads system performance and efficiency (Meta Lattice)](ads/cs1778-new-ai-advancements-drive-metas-ads-system-performance-and.md) — Meta · 2023
- [Beyond Self-Consistency: Loss-Balanced Perturbation-Based Regularization Improves Industrial-Scale Ads Ranking](ads/cs2088-beyond-self-consistency-loss-balanced-perturbation-based-regularization-improves.md) — Meta · 2025
- [Ranking Engineer Agent (REA): The Autonomous AI Agent Accelerating Meta's Ads Ranking Innovation](ads/cs2091-ranking-engineer-agent-rea-the-autonomous-ai-agent-accelerating.md) — Meta · 2026
- [Unlocking Efficient Ad Retrieval: Offline Approximate Nearest Neighbors in Pinterest Ads](ads/cs0788-unlocking-efficient-ad-retrieval-offline-approximate-nearest-neighbors-in.md) — Pinterest · 2025
- [Evolution of Ads Conversion Optimization Models at Pinterest](ads/cs0860-evolution-of-ads-conversion-optimization-models-at-pinterest.md) — Pinterest · 2024
- [DRL-PUT: Deep Reinforcement Learning for Ranking Utility Tuning in the Ad Recommender System at Pinterest](ads/cs1786-drl-put-deep-reinforcement-learning-for-ranking-utility-tuning.md) — Pinterest · 2025
- [Multi-gate-Mixture-of-Experts (MMoE) model architecture and knowledge distillation in Ads Engagement modeling development](ads/cs2087-multi-gate-mixture-of-experts-mmoe-model-architecture-and.md) — Pinterest · 2025
- [Multi-Faceted Large Embedding Tables for Pinterest Ads Ranking](ads/cs2169-multi-faceted-large-embedding-tables-for-pinterest-ads-ranking.md) — Pinterest · 2025
- [Decoupled Entity Representation Learning for Pinterest Ads Ranking](ads/cs2170-decoupled-entity-representation-learning-for-pinterest-ads-ranking.md) — Pinterest · 2025
- [LightSAGE: Graph Neural Networks for Large Scale Item Retrieval in Shopee's Advertisement Recommendation](ads/cs1779-lightsage-graph-neural-networks-for-large-scale-item-retrieval.md) — Shopee · 2023
- [Training Large-Scale Recommendation Models with TPUs](ads/cs2166-training-large-scale-recommendation-models-with-tpus.md) — Snap · 2022
- [Feedback Control for Small Budget Pacing](ads/cs2168-feedback-control-for-small-budget-pacing.md) — Snap · 2025
- [Learning Personalised Prices in Ad Auctions with Game Theory and Deep Learning](ads/cs2084-learning-personalised-prices-in-ad-auctions-with-game-theory.md) — Spotify · 2025
- [Cold-Starting Podcast Ads and Promotions with Multi-Task Learning on Spotify](ads/cs2085-cold-starting-podcast-ads-and-promotions-with-multi-task.md) — Spotify · 2026
- [An Audio-centric Multi-task Learning Framework for Streaming Ads Targeting on Spotify](ads/cs2086-an-audio-centric-multi-task-learning-framework-for-streaming.md) — Spotify · 2025
- [How Taboola Handles Deep Learning Training-Serving Feature Discrepancies (Sherlock)](ads/cs1781-how-taboola-handles-deep-learning-training-serving-feature-discrepancies.md) — Taboola · 2025
- [LFM4Ads: A Large Foundation Model for Ads Recommendation](ads/cs1770-lfm4ads-a-large-foundation-model-for-ads-recommendation.md) — Tencent · 2025
- [Ads Recommendation in a Collapsed and Entangled World](ads/cs1771-ads-recommendation-in-a-collapsed-and-entangled-world.md) — Tencent · 2024
- [Practice on Long Behavior Sequence Modeling in Tencent Advertising](ads/cs1774-practice-on-long-behavior-sequence-modeling-in-tencent-advertising.md) — Tencent · 2025
- [IDProxy: Cold-Start CTR Prediction for Ads and Recommendation at Xiaohongshu with Multimodal LLMs](ads/cs2167-idproxy-cold-start-ctr-prediction-for-ads-and-recommendation.md) — Xiaohongshu · 2026
...
- [Robust LLM Training Infrastructure at ByteDance](mlops/cs2344-robust-llm-training-infrastructure-at-bytedance.md) — ByteDance · 2025
- [DevOps for Machine Learning – What does this mean, and why do you need it?](mlops/cs2403-devops-for-machine-learning-what-does-this-mean-and.md) — Delivery Hero · 2021
- [How Low-Bit Inference Enables Efficient AI](mlops/cs2265-how-low-bit-inference-enables-efficient-ai.md) — Dropbox · 2026
- [Modernising Grab's model serving platform with NVIDIA Triton Inference Server](mlops/cs2133-modernising-grabs-model-serving-platform-with-nvidia-triton-inference.md) — Grab · 2025
- [Grab AI Gateway: Connecting Grabbers to multiple GenAI providers](mlops/cs2134-grab-ai-gateway-connecting-grabbers-to-multiple-genai-providers.md) — Grab · 2025
- [Introducing Griffin 2.0: Instacart's Next-Gen ML Platform](mlops/cs2339-introducing-griffin-20-instacarts-next-gen-ml-platform.md) — Instacart · 2024
- [Unveiling the Core of Instacart's Griffin 2.0: A Deep Dive Into the Model Serving Platform](mlops/cs2340-unveiling-the-core-of-instacarts-griffin-20-a-deep.md) — Instacart · 2024
- [Griffin: How Instacart's ML Platform Tripled ML Applications in a Year](mlops/cs2341-griffin-how-instacarts-ml-platform-tripled-ml-applications-in.md) — Instacart · 2023
- [Distributed Machine Learning at Instacart](mlops/cs2342-distributed-machine-learning-at-instacart.md) — Instacart · 2024
...
- [Slack AI: The Path to Multi-Cloud](mlops/cs2264-slack-ai-the-path-to-multi-cloud.md) — Slack · 2026
- [Beyond Winning: Spotify's Experiments with Learning Framework](mlops/cs2261-beyond-winning-spotifys-experiments-with-learning-framework.md) — Spotify · 2025
- [Railyard: how we rapidly train machine learning models with Kubernetes](mlops/cs2402-railyard-how-we-rapidly-train-machine-learning-models-with.md) — Stripe · 2021
...
- [DeepStock: Reinforcement Learning with Policy Regularizations for Inventory Management](rl/cs2158-deepstock-reinforcement-learning-with-policy-regularizations-for-inventory-management.md) — Alibaba · 2025
- [MTORL: Multi-task Offline Reinforcement Learning for Online Advertising in Recommender Systems](rl/cs2299-mtorl-multi-task-offline-reinforcement-learning-for-online-advertising.md) — Alibaba · 2025
- [CanniUplift: A Holistic Framework for Mitigating Seller and Incentive Cannibalization in E-commerce Uplift Modeling](rl/cs2300-canniuplift-a-holistic-framework-for-mitigating-seller-and-incentive.md) — Alibaba · 2026
- [Design Principles of Robust Multi-Armed Bandit Framework in Video Recommendations](rl/cs2159-design-principles-of-robust-multi-armed-bandit-framework-in.md) — Amazon Prime Video · 2023
- [Constitutional AI: Harmlessness from AI Feedback](rl/cs2355-constitutional-ai-harmlessness-from-ai-feedback.md) — Anthropic · 2022
- [Reinforcement Learning from Developer Behaviors: A Breakthrough in Code Generation Quality](rl/cs2156-reinforcement-learning-from-developer-behaviors-a-breakthrough-in-code.md) — Augment Code · 2025
- [RELATE: A Reinforcement Learning-Enhanced LLM Framework for Advertising Text Generation](rl/cs2303-relate-a-reinforcement-learning-enhanced-llm-framework-for-advertising.md) — Baidu · 2026
- [Improving Cursor Tab with Online RL](rl/cs2153-improving-cursor-tab-with-online-rl.md) — Cursor · 2025
- [Hierarchical Contextual Uplift Bandits for Catalog Personalization](rl/cs2154-hierarchical-contextual-uplift-bandits-for-catalog-personalization.md) — Dream11 · 2025
- [TSCAN: Context-Aware Uplift Modeling via Two-Stage Training for Online Merchant Business Diagnosis](rl/cs2302-tscan-context-aware-uplift-modeling-via-two-stage-training.md) — Ele.me · 2025
- [VALOR: Value-Aware Revenue Uplift Modeling with Treatment-Gated Representation for B2B Sales](rl/cs2301-valor-value-aware-revenue-uplift-modeling-with-treatment-gated.md) — Google · 2026
- [Chip Placement with Deep Reinforcement Learning](rl/cs2357-chip-placement-with-deep-reinforcement-learning.md) — Google Brain · 2020
- [Gemini: A Family of Highly Capable Multimodal Models](rl/cs2358-gemini-a-family-of-highly-capable-multimodal-models.md) — Google DeepMind · 2023
- [AURO: Reinforcement Learning for Adaptive User Retention Optimization in Recommender Systems](rl/cs2297-auro-reinforcement-learning-for-adaptive-user-retention-optimization-in.md) — Kuaishou · 2023
- [GAS: Generative Auto-bidding with Post-training Search](rl/cs2298-gas-generative-auto-bidding-with-post-training-search.md) — Kuaishou · 2024
- [Simulator-based Reinforcement Learning for Data Center Cooling Optimization](rl/cs2295-simulator-based-reinforcement-learning-for-data-center-cooling-optimization.md) — Meta · 2024
- [Improving Generative Ad Text on Facebook using Reinforcement Learning](rl/cs2296-improving-generative-ad-text-on-facebook-using-reinforcement-learning.md) — Meta · 2025
- [Llama 2: Open Foundation and Fine-Tuned Chat Models](rl/cs2356-llama-2-open-foundation-and-fine-tuned-chat-models.md) — Meta · 2023
- [Training language models to follow instructions with human feedback (InstructGPT)](rl/cs2354-training-language-models-to-follow-instructions-with-human-feedback.md) — OpenAI · 2022
...
- [QARM: Quantitative Alignment Multi-Modal Recommendation at Kuaishou](rec/cs2151-qarm-quantitative-alignment-multi-modal-recommendation-at-kuaishou.md) — Kuaishou · 2024
- [LiveForesighter: Generating Future Information for Live-Streaming Recommendations at Kuaishou](rec/cs2353-liveforesighter-generating-future-information-for-live-streaming-recommendations-at.md) — Kuaishou · 2025
- [Turbocharging LinkedIn's Recommendation Systems with SGLang](rec/cs2290-turbocharging-linkedins-recommendation-systems-with-sglang.md) — LinkedIn · 2025
- [Scaling LLM-Based Ranking Systems with SGLang at LinkedIn](rec/cs2291-scaling-llm-based-ranking-systems-with-sglang-at-linkedin.md) — LinkedIn · 2026
- [SilverTorch: Index as Model — A New Retrieval Paradigm for Recommendation Systems](rec/cs2288-silvertorch-index-as-model-a-new-retrieval-paradigm-for.md) — Meta · 2026
- [Adapting the Facebook Reels RecSys AI Model Based on User Feedback](rec/cs2289-adapting-the-facebook-reels-recsys-ai-model-based-on.md) — Meta · 2026
- [PinRec: Outcome-Conditioned Generative Retrieval for Pinterest Recommendations](rec/cs2146-pinrec-outcome-conditioned-generative-retrieval-for-pinterest-recommendations.md) — Pinterest · 2025
- [UniPinRec: Unified Retrieval and Ranking in a Single Model at Pinterest](rec/cs2147-unipinrec-unified-retrieval-and-ranking-in-a-single-model.md) — Pinterest · 2026
- [GPU-Serving Two-Tower Models for Lightweight Ads Engagement Prediction](rec/cs2292-gpu-serving-two-tower-models-for-lightweight-ads-engagement.md) — Pinterest · 2026
- [Achieving Near-Linear Training Scalability for Pinterest's Foundation Models](rec/cs2293-achieving-near-linear-training-scalability-for-pinterests-foundation-models.md) — Pinterest · 2026
- [OnePiece: Context Engineering and Reasoning for Cascade Ranking at Shopee](rec/cs2150-onepiece-context-engineering-and-reasoning-for-cascade-ranking-at.md) — Shopee · 2025
- [Universal User Modeling (UUM): Foundation Model for Cross-Surface User Understanding at Snap](rec/cs2148-universal-user-modeling-uum-foundation-model-for-cross-surface.md) — Snap · 2025
- [Speed Up Feature Engineering for Recommendation Systems](rec/cs2352-speed-up-feature-engineering-for-recommendation-systems.md) — Snap · 2024
- [GLIDE: Deploying Semantic ID-based Generative Retrieval for Podcast Discovery at Spotify](rec/cs2149-glide-deploying-semantic-id-based-generative-retrieval-for-podcast.md) — Spotify · 2026
- [Teaching Large Language Models to Speak Spotify: Semantic IDs for LLM-Powered Personalization](rec/cs2152-teaching-large-language-models-to-speak-spotify-semantic-ids.md) — Spotify · 2025
- [Weighing dynamic availability and consumption for Twitch recommendations](rec/cs2350-weighing-dynamic-availability-and-consumption-for-twitch-recommendations.md) — Twitch · 2022
...
- [Scaling Airbnb's Identity Graph with a Unified Knowledge Graph Infrastructure](fraud/cs2215-scaling-airbnbs-identity-graph-with-a-unified-knowledge-graph.md) — Airbnb · 2026
- [Arming Customer Service with Technology to Detect Fraud Over the Phone](fraud/cs2388-arming-customer-service-with-technology-to-detect-fraud-over.md) — Block (Square) · 2022
- [Reducing Fraud Loss With an Automated Dynamic Policy](fraud/cs2218-reducing-fraud-loss-with-an-automated-dynamic-policy.md) — Coinbase · 2026
- [How Inscribe Uses Amazon Bedrock to Stop Document Fraud in Seconds](fraud/cs2123-how-inscribe-uses-amazon-bedrock-to-stop-document-fraud.md) — Inscribe · 2024
- [Mastercard Accelerates Card Fraud Detection with Generative AI Technology](fraud/cs2122-mastercard-accelerates-card-fraud-detection-with-generative-ai-technology.md) — Mastercard · 2024
- [How Nubank Models Risk for Smarter, Scalable Credit Limit Increases](fraud/cs2217-how-nubank-models-risk-for-smarter-scalable-credit-limit.md) — Nubank · 2025
- [Introducing Ti2: The Next Generation of Plaid Protect's Trust Index](fraud/cs2119-introducing-ti2-the-next-generation-of-plaid-protects-trust.md) — Plaid · 2025
- [Ti3 is Here: A Bigger Graph for a Fast Moving Fraud Landscape](fraud/cs2120-ti3-is-here-a-bigger-graph-for-a-fast.md) — Plaid · 2026
- [PRAGMA: Revolut Foundation Model for Payments and Fraud](fraud/cs2121-pragma-revolut-foundation-model-for-payments-and-fraud.md) — Revolut · 2026
- [Building a state-of-the-art card fraud detection system in 9 months](fraud/cs2387-building-a-state-of-the-art-card-fraud-detection.md) — Revolut · 2023
- [How Shopify Payments Uses Machine Learning to Boost Payment Success Rates and Cut Fraud Chargebacks](fraud/cs2118-how-shopify-payments-uses-machine-learning-to-boost-payment.md) — Shopify · 2025
...
- [UNIVID: Unified Vision-Language Model for Video Moderation](moderation/cs2140-univid-unified-vision-language-model-for-video-moderation.md) — ByteDance · 2026
- [How LLMs Help Us Make Content Moderation More Precise](moderation/cs2137-how-llms-help-us-make-content-moderation-more-precise.md) — Grab · 2025
- [VLM as Policy: Common-Law Content Moderation Framework for Short Video Platform (KuaiMod)](moderation/cs2139-vlm-as-policy-common-law-content-moderation-framework-for.md) — Kuaishou · 2025
- [CASAL: Building Trust and Combating Abuse — The Anti-Abuse Core at LinkedIn](moderation/cs2267-casal-building-trust-and-combating-abuse-the-anti-abuse.md) — LinkedIn · 2023
- [New Approaches for Detecting AI-Generated Profile Photos at LinkedIn](moderation/cs2268-new-approaches-for-detecting-ai-generated-profile-photos-at.md) — LinkedIn · 2023
- [Federated Anti-Abuse Defense Ecosystem Using AI at LinkedIn](moderation/cs2269-federated-anti-abuse-defense-ecosystem-using-ai-at-linkedin.md) — LinkedIn · 2024
- [Evolution of Enforcing Professional Community Policies at Scale at LinkedIn](moderation/cs2270-evolution-of-enforcing-professional-community-policies-at-scale-at.md) — LinkedIn · 2024
- [PurpleLlama: Meta's Open Safety Toolkit for LLMs Including Llama Guard, Prompt Guard, and Code Shield](moderation/cs2346-purplellama-metas-open-safety-toolkit-for-llms-including-llama.md) — Meta · 2023
- [Sentinel: Roblox's Open-Source Contrastive Learning Library for Detecting Rare Harmful Text in Real-Time](moderation/cs2347-sentinel-robloxs-open-source-contrastive-learning-library-for-detecting.md) — Roblox · 2025
- [Using Gen AI to Enhance Trust and Safety at Thumbtack: Applying a Fine-Tuned LLM Model to Review Messages](moderation/cs2138-using-gen-ai-to-enhance-trust-and-safety-at.md) — Thumbtack · 2025
- [Filter-And-Refine: Multimodal LLM Cascade for Industrial Video Content Moderation](moderation/cs2266-filter-and-refine-multimodal-llm-cascade-for-industrial-video.md) — TikTok · 2025
- [Large Language Models for Toxicity Detection: ToxBuster](moderation/cs2141-large-language-models-for-toxicity-detection-toxbuster.md) — Ubisoft · 2025
- [ORES: Wikimedia Foundation's ML Scoring Service for Wikipedia Edit Quality and Vandalism Detection](moderation/cs2348-ores-wikimedia-foundations-ml-scoring-service-for-wikipedia-edit.md) — Wikimedia Foundation · 2015
- [Community Notes: X's Open-Source Bridging Algorithm for Collaborative Misinformation Labeling](moderation/cs2345-community-notes-xs-open-source-bridging-algorithm-for-collaborative.md) — X (formerly Twitter) · 2022

## Optimization & OR (14)

- [Regionalize and Scale: Amazon's Fulfillment Network Design for Faster and Cheaper Delivery](optim/cs2284-regionalize-and-scale-amazons-fulfillment-network-design-for-faster.md) — Amazon · 2025
- [How BASF manages thousands of supply chain decisions with AlphaEvolve](optim/cs2407-how-basf-manages-thousands-of-supply-chain-decisions-with.md) — BASF · 2026
- [Innovative Integer Programming Software and Methods for Large-Scale Routing at DHL Supply Chain](optim/cs2286-innovative-integer-programming-software-and-methods-for-large-scale.md) — DHL · 2024
- [Faster, Smarter, Leaner: How Flipkart Optimized Its Supply Chain to Unlock Growth](optim/cs2287-faster-smarter-leaner-how-flipkart-optimized-its-supply-chain.md) — Flipkart · 2026
- [How FM Logistic tackled the traveling salesman problem at warehouse scale with AlphaEvolve](optim/cs2406-how-fm-logistic-tackled-the-traveling-salesman-problem-at.md) — FM Logistic · 2026
- [Don't let the crow guide your routes](optim/cs2408-dont-let-the-crow-guide-your-routes.md) — Instacart · 2022
- [Real-Time Intelligent Dispatching Algorithms Build the World's Largest Minute-Level Delivery Network](optim/cs2278-real-time-intelligent-dispatching-algorithms-build-the-worlds-largest.md) — Meituan · 2024
- [Using Optimization and LLMs to Enhance Cloud Supply Chain Operations](optim/cs2145-using-optimization-and-llms-to-enhance-cloud-supply-chain.md) — Microsoft · 2024
- [Data-Driven at Sea: Forecasting and Revenue Management at Molslinjen](optim/cs2283-data-driven-at-sea-forecasting-and-revenue-management-at.md) — Molslinjen · 2025
- [PepsiCo Deploys AI-Driven Pricing and Promotion Optimization at Scale](optim/cs2285-pepsico-deploys-ai-driven-pricing-and-promotion-optimization-at.md) — PepsiCo · 2026
- [Simulation-Optimization for Resource Allocation at SF Express Hub](optim/cs2281-simulation-optimization-for-resource-allocation-at-sf-express-hub.md) — SF Express · 2024
- [SF Express Revolutionizes Its Operations Planning Strategy Using Operations Research](optim/cs2282-sf-express-revolutionizes-its-operations-planning-strategy-using-operations.md) — SF Express · 2025
- [Optimizing Walmart's Supply Chain from Strategy to Execution](optim/cs2279-optimizing-walmarts-supply-chain-from-strategy-to-execution.md) — Walmart · 2024
- [Dynamic Route Optimization and Automation of Industrial Routes at WM](optim/cs2280-dynamic-route-optimization-and-automation-of-industrial-routes-at.md) — WM · 2026

## NLP (classic) (12)

- [Rationale-Guided Distillation for E-Commerce Relevance Classification: Bridging Large Language Models and Lightweight Cross-Encoders](nlp/cs2277-rationale-guided-distillation-for-e-commerce-relevance-classification-bridging.md) — Amazon · 2025
- [Weaving Together Review Insights by Leveraging LLMs](nlp/cs2276-weaving-together-review-insights-by-leveraging-llms.md) — Best Buy · 2025
- [Text2Topic: Multi-Label Text Classification System for Efficient Topic Detection in User Generated Content with Zero-Shot Capabilities](nlp/cs2272-text2topic-multi-label-text-classification-system-for-efficient-topic.md) — Booking.com · 2023
- [How Grammarly Uses NLP & ML to Identify Main Points](nlp/cs2142-how-grammarly-uses-nlp-ml-to-identify-main-points.md) — Grammarly · 2024
- [Building Bilingual NER for Cargo Logistics with Amazon Bedrock](nlp/cs2271-building-bilingual-ner-for-cargo-logistics-with-amazon-bedrock.md) — IBS Software · 2026
- [LM-Based Query Categorization for Query Understanding at Mercari](nlp/cs2143-lm-based-query-categorization-for-query-understanding-at-mercari.md) — Mercari · 2023
- [Cross-Domain Web Information Extraction at Pinterest](nlp/cs2273-cross-domain-web-information-extraction-at-pinterest.md) — Pinterest · 2025
- [Why Plaid Built the Transaction Enrichment Engine](nlp/cs2144-why-plaid-built-the-transaction-enrichment-engine.md) — Plaid · 2023
- [Semantic Question Matching with Deep Learning](nlp/cs2405-semantic-question-matching-with-deep-learning.md) — Quora · 2017
- [How Thomson Reuters Accelerated Research and Development of Natural Language Processing Solutions with Amazon SageMaker](nlp/cs2404-how-thomson-reuters-accelerated-research-and-development-of-natural.md) — Thomson Reuters · 2021
- [LLM-Ensemble: Optimal Large Language Model Ensemble Method for E-commerce Product Attribute Value Extraction](nlp/cs2274-llm-ensemble-optimal-large-language-model-ensemble-method-for.md) — Walmart · 2024
- [Cost-Effective E-Commerce Catalog Translation at Scale Ensuring Named Entity Protection](nlp/cs2275-cost-effective-e-commerce-catalog-translation-at-scale-ensuring.md) — Walmart · 2025
